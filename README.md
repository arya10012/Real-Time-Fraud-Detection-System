...
```bash
# Clone repository
git clone https://github.com/arya10012/fraud-detection-system.git
...
- 🔗 **GitHub**: [@AryaBhor](https://github.com/arya10012)
- 💼 **LinkedIn**: [Connect with me](https://linkedin.com/in/aryabhor1001)
